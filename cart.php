...
<section class="products">
    ...
    <div class="box-container">
        ...
        <form action="" method="post" class="box">
            ...
            <div class="flex">
                <div class="price">
                    <span class="original-price">Rs.<?= htmlspecialchars($original_price); ?></span> 
            ...
            <div class="sub-total">Sub total price: <span>Rs.<?= number_format($sub_total, 2); ?>/-</span></div>
        </form>
        <?php
    ...
    <div class="cart-total">
        <p>Cart total price: <span>Rs.<?= number_format($grand_total, 2); ?></span></p>
